...
export class BookSubjectList extends Component {
    ...
    copyEmptyRow() {
        return Object.assign({}, BookSubjectList.emptyRow);
    }
    ...
    async addRow() {
        ...
        await fetch(BookSubjectList.baseUrl, {
            method: 'POST',
    ...
    async handleSave(e) {
        for (const [key, value] of Object.entries(BookSubjectList.emptyRow)) {
