...
export class MovieGenreList extends Component {
    ...
    copyEmptyRow() {
        return Object.assign({}, MovieGenreList.emptyRow);
    }
    ...
    async addRow() {
        ...
        await fetch(MovieGenreList.baseUrl, {
            method: 'POST',
    ...
    async editRow() {
        ...
        await fetch(MovieGenreList.baseUrl + this.state.currentRow.id, {
            method: 'PUT',
            body: JSON.stringify(this.state.currentRow),
            headers: {
                'content-type': 'application/json'
    ...
    async handleSave(e) {
        for (const [key, value] of Object.entries(MovieGenreList.emptyRow)) {
