...
export class SongGenreList extends Component {
    static baseUrl = 'api/ProductSongGenres/';
    static displayName = SongGenreList.name;
    static emptyRow = {
        name: '',
    }
    ...
    copyEmptyRow() {
        return Object.assign({}, SongGenreList.emptyRow);
    }
    ...
    async addRow() {
        ...
        await fetch(SongGenreList.baseUrl, {
            method: 'POST',
    ...
    async editRow() {
        ...
        await fetch(SongGenreList.baseUrl + this.state.currentRow.id, {
            method: 'PUT',
            body: JSON.stringify(this.state.currentRow),
            headers: {
                'content-type': 'application/json'
    ...
    async handleSave(e) {
        for (const [key, value] of Object.entries(SongGenreList.emptyRow)) {
