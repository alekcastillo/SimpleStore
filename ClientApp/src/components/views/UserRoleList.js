...
export class UserRoleList extends Component {
    ...
    copyEmptyRow() {
        return Object.assign({}, UserRoleList.emptyRow);
    }
    ...
    async addRow() {
        ...
        await fetch(UserRoleList.baseUrl, {
            method: 'POST',
    ...
    async editRow() {
        ...
        await fetch(UserRoleList.baseUrl + this.state.currentRow.id, {
            method: 'PUT',
            body: JSON.stringify(this.state.currentRow),
            headers: {
                'content-type': 'application/json'
    ...
    async handleSave(e) {
        for (const [key, value] of Object.entries(UserRoleList.emptyRow)) {
        ...
        return (
            <div style={{ maxWidth: '100%' }}>
                ...
                <Modal isOpen={this.state.editModal}>
                    <ModalHeader>Rol Usuario</ModalHeader>
                    <ModalBody>
